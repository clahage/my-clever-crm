        ...
        <main className="flex-1 bg-gray-50">
          ...
          <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}>
            <Routes>
              ...
              <Route path="/client-management" element={<LazyLoading component={React.lazy(() => import('./pages/ClientManagement.jsx'))} fallback={<div>Loading client management...</div>} />} />
              ...
              <Route path="/client-portal/*" element={
                <Suspense fallback={<div>Loading client portal...</div>}>
                  <ClientPortal />
                  <Routes>
              ...
              <Route path="/admin/disputes" element={<AdminRoute><AdminDisputeManager /></AdminRoute>} />
              <Route path="/admin/documents" element={<AdminRoute><AdminDocumentViewer /></AdminRoute>} />
