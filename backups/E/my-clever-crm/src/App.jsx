...
const Clients = React.lazy(() => import('./pages/ClientList.jsx'));
...
const Prospects = React.lazy(() => import('./pages/Prospects.jsx'));
      ...
      <main className="flex-1 bg-gray-50">
        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}>
          <Routes>
            ...
            <Route path="/openai" element={<RouteWrapper component={React.lazy(() => import('./pages/OpenAI.jsx'))} componentName="OpenAI" />} />
