...
exports.scoreLead = async (data, context) => {
  try {
    ...
    if (!data.leadData) {
      throw new functions.https.HttpsError('invalid-argument', 'Lead data is required.');
    }
...
exports.getAllAIUsage = async (data, context) => {
  try {
    ...
    if (userRole !== 'admin' && userRole !== 'masterAdmin') {
      throw new functions.https.HttpsError('permission-denied', 'Only admins can access this endpoint.');
    }
