...
const EditClientForm = ({ client, onClose, onSuccess }) => {
  const initialState = {
    ...
    initialScore: client.initialScore || '',
    activeDisputes: client.activeDisputes || 0,
    resolvedDisputes: client.resolvedDisputes || 0
  };
  ...
  return (
    <div style={{position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: 'rgba(0,0,0,0.25)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
      <div style={{background: '#fff', padding: 32, borderRadius: 10, minWidth: 340, boxShadow: '0 2px 16px #aaa', position: 'relative'}}>
        <h2 style={{fontSize: 22, fontWeight: 'bold', marginBottom: 18}}>Edit Client</h2>
        <form onSubmit={handleSubmit}>
          ...
          {success && <div style={{color: '#388e3c', marginBottom: 10}}>Client updated successfully!</div>}
