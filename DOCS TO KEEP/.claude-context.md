# 🎯 SpeedyCRM - Claude Code Context & Standards
...
- ✅ 6-12 tabs per hub (not more)

- ✅ Each tab is a full-featured component

- ✅ Tabs can be 500-2,000 lines each
...
- ✅ Comprehensive comments with ===== headers
...
## 🎨 CODE QUALITY STANDARDS (TIER 5+ ENTERPRISE)

 

### General Rules:

- ❌ **NEVER** use test/fake/placeholder data
...
- ✅ i18n-ready (English/Spanish comments)
...
│   ├── hubs/          # All hub components (20 total after consolidation)

│   ├── [standalone]/  # Standalone pages (minimal)
...
├── layout/            # ProtectedLayout.jsx, navConfig.js
...
- ContactDetailPage.jsx → Tab 5

- ClientIntake.jsx → Tab 4
...
- PaymentIntegrationHub → Tab 5

- CollectionsARHub → Tab 6
...
- MobileScreenBuilder → Tab 3

- PushNotificationManager → Tab 5

- MobileAnalyticsDashboard → Tab 7
...
- ✅ Minimum 30-50 AI features per hub
...
- ✅ Consolidate 41 hubs → 20 hubs (51% reduction)

- ✅ Pipeline as full-featured tab in Clients Hub (Option A)

- ✅ Use full 3,682-line Calendar.jsx in Tasks & Productivity Hub

- ✅ Keep 7 specialized service hubs separate (not consolidated)

- ✅ Current 8-role hierarchy is sufficient

- ✅ Implement "My Power Page" feature in Smart Dashboard Tab 7

- ✅ Use Sonnet 4.5 for implementation (95% of work)
...
- ❌ Remove any features during consolidation

- ❌ Use test/fake/placeholder data
...
- ✅ Preserve 100% of features during consolidation

- ✅ Test thoroughly before committing

- ✅ Update navConfig.js when changing navigation

- ✅ Update App.jsx routes when needed
...
1. Mobile Application Hub (8 hubs → 1)

2. Financial Operations Hub (6 hubs → 1)

3. Clients & Pipeline Hub (6 items → 1)

4. Communications Hub (7 items → 1)

5. Referrals & Partnerships Hub (5 hubs → 1)

 

### Phase 2 (Week 2-3): High-Priority Merges

6. Enterprise Learning Hub (8+ items → 1)

7. Documents & Contracts Hub (12 items → 1)

8. Marketing & Campaigns Hub (6 hubs → 1)

9. Dispute Management Hub (4 items → 1)

10. Credit Reports & Analysis Hub (5 items → 1)

11. Tasks & Productivity Hub (6 items → 1)

 

### Phase 3 (Week 4): Medium-Priority

12. Revenue & Analytics Hub (3 hubs → 1)

13. Settings & Administration Hub (3 hubs → 1)

14. Client Success Hub (3 hubs → 1)
...
- ❌ Don't deviate from patterns without discussion
