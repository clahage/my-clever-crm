...
import MegaContactForm from '@/components/forms/MegaContactForm';
...
const Contacts = () => {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-full">
      ...
      {/* Mega Contact Form Modal */}
      {(() => {
        console.log('🔍 RENDER CHECK:', {
          showMegaForm,
          componentExists: !!MegaContactForm,
          componentType: typeof MegaContactForm,
          editingContact,
          formMode
        });
        return null;
      ...
      {showMegaForm && (
        <>
          {console.log('🟢 RENDERING MegaContactForm NOW!')}
          <MegaContactForm
            onClose={() => {
