      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <button
              onClick={() => navigate('/credit-scores')}
              className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow flex flex-col items-center"
            >
              <span className="text-2xl mb-2">📈</span>
            ...
            >
              <span className="text-2xl mb-2">📝</span>
              <span className="text-sm">Dispute Letters</span>
            </button>
            <button
        ...
        {/* Client Portal Access - for testing */}
        <div className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            View the client experience and test ScoreView™ features
          </p>
          <button
