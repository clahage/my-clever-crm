...
// Default service plans (3-plan system — matches servicePlans.js)
const DEFAULT_PLANS = [
  {
    name: 'Essentials',
    slug: 'essentials',
    description: 'Take control of your credit with AI-powered tools and expert templates',
    monthlyPrice: 79,
    setupFee: 49,
    perDeletion: 0,
    features: [
    ...
    eligibilityCriteria: {
      ...
      minNegativeItems: 0,
      maxNegativeItems: 5,
      customRules: ['Self-motivated individuals', 'Minor credit issues', 'Budget-conscious'],
    },
    ...
    color: '#10b981',
    icon: 'BookOpen',
    targetAudience: 'Self-motivated individuals with 1-5 negative items',
    estimatedTimeline: '3-9 months (self-paced)',
    disputeMethod: 'Client sends (mail). Fax available a la carte ($10/letter).',
  },
  {
    name: 'Professional',
    slug: 'professional',
    description: 'Full-service credit repair — we handle everything for you',
    monthlyPrice: 149,
    setupFee: 0,
    perDeletion: 25,
    features: [
    ...
    eligibilityCriteria: {
      ...
      minNegativeItems: 5,
      maxNegativeItems: 30,
      customRules: ['Typical credit repair case', 'Wants full-service help'],
    },
  ...
  },
  {
    name: 'VIP Concierge',
    slug: 'vip',
    description: 'Maximum results, maximum speed — white-glove credit restoration',
    monthlyPrice: 299,
    setupFee: 0,
    perDeletion: 0,
    features: [
    ...
    eligibilityCriteria: {
      ...
      customRules: ['Complex cases', 'Urgent timeline', 'Wants zero surprise charges'],
    },
    contractDuration: '6-month',
    active: true,
    displayOrder: 3,
    color: '#f59e0b',
    icon: 'Crown',
    targetAudience: 'Complex cases with 15+ items, urgent timeline',
    estimatedTimeline: '2-5 months (accelerated)',
    premium: true,
