...
export async function createContact(data) {
  ...
  if (
    contact.platform === "Google My Business" &&
    !contact.sourceDetails.messageUrl
  ) {
    throw new Error("Google My Business contact requires reviewUrl");
  }
  if (
    contact.platform === "Facebook" &&
    !contact.sourceDetails.pageUrl &&
    !contact.sourceDetails.profileUrl
  ) {
  ...
  if (
    ...
    !contact.sourceDetails.profileUrl &&
    !contact.sourceDetails.companyUrl
  ) {
...
export const sampleContacts = [
  {
    ...
    platform: "Yelp",
    sourceDetails: {
      businessName: "Jane Credit",
      reviewUrl: "yelp.com/jane",
    },
    conversation: {
      callSummary: "Asked about services",
      sentiment: "Excited",
      urgency: "ASAP",
    },
    ai: {
      aiCategory: "Hot Lead",
      aiConfidence: 95,
      aiNotes: "Ready to buy",
    },
    autoResponse: {
      autoResponseSent: true,
      responseTime: "2m",
      responseTemplate: "Thank you for contacting us",
    },
    leadScoring: {
      leadScore: 90,
      scoreFactors: {
